...
<head>
    ...
    <script src="https://kit.fontawesome.com/f4410557e3.js" crossorigin="anonymous"></script>
    <link rel="stylesheet" href="{{ asset('asset/css/style11.css') }}">
...
<body>
    <div class="header-section">
        <div class="container-fluid header11">
